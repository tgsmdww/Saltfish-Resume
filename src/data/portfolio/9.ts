export const information = {
  heading: "GPK: An Efficient Special Character Input Method for Keyboards Using Glide",
  introduction: "A swipe-based input method for users with keyboard and mouse only to type special characters",
  title1: "ABSTRACT",
  content1:
...
export const QA = [
  ...
  {
    question: "Now it just provided a web version, what if I want to use it ubiquitously?",
    answer:
